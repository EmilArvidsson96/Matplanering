...
const FILTERS: { key: string; label: string; values: { id: string; label: string }[] }[] = [
  ...
  { key: 'type', label: 'Typ', values: [
    ...
    { id: 'pasta', label: 'Pasta' }, { id: 'curry', label: 'Curry' },
    { id: 'risotto', label: 'Risotto' }, { id: 'omelett', label: 'Omelett' },
    { id: 'smörgås', label: 'Smörgås' }, { id: 'wok', label: 'Wok' },
    { id: 'sushi', label: 'Sushi' }, { id: 'köttbit', label: 'Köttbit' },
  ]},
